  ...
  components: {
    ...
    MuiAlert: {
      styleOverrides: {
        ...
        standardError:   { borderColor: alpha('#f87171', 0.25), backgroundColor: alpha('#f87171', 0.06) },
        standardSuccess: { borderColor: alpha('#4ade80', 0.25), backgroundColor: alpha('#4ade80', 0.06) },
        standardWarning: { borderColor: alpha('#fbbf24', 0.25), backgroundColor: alpha('#fbbf24', 0.06) },
        standardInfo:    { borderColor: alpha('#60a5fa', 0.25), backgroundColor: alpha('#60a5fa', 0.06) },
      },
    },
