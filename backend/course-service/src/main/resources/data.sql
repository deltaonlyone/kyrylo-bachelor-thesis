...
VALUES (1, 'DevOps для ІТ-команд', 'Практичний курс з CI/CD, Docker, Kubernetes та хмарних технологій для розробників і сисадмінів.', 'PUBLISHED');
...
-- Питання 1
INSERT INTO questions (id, quiz_id, text, sort_order)
VALUES (1, 1, 'Що означає абревіатура DevOps?', 1);
...
-- Питання 2
INSERT INTO questions (id, quiz_id, text, sort_order)
VALUES (2, 1, 'Яка з практик відповідає за автоматичне розгортання коду?', 2);
...
-- Питання 3
INSERT INTO questions (id, quiz_id, text, sort_order)
VALUES (3, 1, 'Який інструмент НЕ є CI/CD платформою?', 3);
...
-- Питання 1
INSERT INTO questions (id, quiz_id, text, sort_order)
VALUES (4, 2, 'Що таке Docker Image?', 1);
...
-- Питання 2
INSERT INTO questions (id, quiz_id, text, sort_order)
VALUES (5, 2, 'Яка команда запустить контейнер і пробросить порт 8080?', 2);
...
INSERT INTO courses (id, title, description, status)
VALUES (2, 'Основи хмарних технологій (AWS/GCP)', 'Вступ до хмарних платформ: сервіси зберігання, обчислення та мережі для ІТ-спеціалістів.', 'PUBLISHED');
...
INSERT INTO courses (id, title, description, status)
VALUES (3, 'Cybersecurity для розробників', 'Базові принципи безпеки: OWASP Top 10, аутентифікація, шифрування.', 'DRAFT');
